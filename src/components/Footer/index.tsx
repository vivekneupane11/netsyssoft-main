...
<footer className="bg-white  w-full ">
    ...
    <div className=" py-6 bg-[#002C5F]  md:flex md:items-center md:justify-between">
       ...
       <span className="text-sm text-gray-100  sm:text-center">© 2023 <a href="https://flowbite.com/">NSS</a>.  All Right Reserved.
        </span>
        <span className="text-sm text-gray-100  sm:text-center">Call : +977 9761754929 </span>
